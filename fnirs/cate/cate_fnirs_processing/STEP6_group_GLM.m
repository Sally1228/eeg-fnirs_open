...
% - Terms use "task" (marker=1); ROIs are LeftFrontal/LeftTemporal/RightFrontal/RightTemporal.
...
% Analysis options
termsToUse = {'task'}; % empty = all terms
doFdr = true;
fdrAlpha = 0.05;
...
fprintf('[INFO] Assumptions: term=task (marker=1), ROI=LeftFrontal/LeftTemporal/RightFrontal/RightTemporal\n');
