...
for i = 1:length(SUB)
    ...
    %删除休息段，有效的marker是1 2 4 8 ,间隔>3.5s，前后各预留2s
    EEG  = pop_erplabDeleteTimeSegments( EEG , 'displayEEG', 0, 'endEventcodeBufferMS',  2000, 'ignoreUseEventcodes', [1,2,4,8], 'ignoreUseType', 'Use', 'startEventcodeBufferMS',  2000, 'timeThresholdMS',  3500 );
    ...
    [ndata, text, alldata] = xlsread(fullfile(input_dir, 'ICA_Prep_Values_recog.xlsx')); 
