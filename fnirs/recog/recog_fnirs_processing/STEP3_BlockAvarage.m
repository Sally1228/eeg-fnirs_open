...
% Block-average analysis for recogtory oddball task
%
% Assumptions & Notes:
...
% thisDir = '/Users/zhaifeifei/Desktop/eeg_fnirs/fnirs/recog/recog_fnirs_processing'
...
for si = 1:numel(subjList)
    ...
    %% ===================== [8] SAVE OUTPUTS =====================
    outMat = fullfile(outDir, sprintf('%s_task-recog_blockavg.mat', subName));
    save(outMat, 'results', 'stim', 'roiDefs', 'blockOnsets', 'blockDurationSecUsed', '-v7.3');

    outCsv = fullfile(outDir, sprintf('%s_task-recog_blockavg_table.csv', subName));
    ...
    figPath0 = fullfile(figDir, sprintf('%s_task-recog_step-blockavg_qc_blockboundaries.png', subName));
    ...
    figPath1 = fullfile(figDir, sprintf('%s_task-recog_step-blockavg_qc_channels.png', subName));
    ...
    figPath2 = fullfile(figDir, sprintf('%s_task-recog_step-blockavg_signal.png', subName));
    ...
    figPath3 = fullfile(figDir, sprintf('%s_task-recog_step-blockavg_result.png', subName));
    ...
    figPath4 = fullfile(figDir, sprintf('%s_task-recog_step-blockavg_trend.png', subName));
