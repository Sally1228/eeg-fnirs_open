...
% script_dir = '/Users/zhaifeifei/Desktop/eeg_fnirs/eeg/cate/cate_EEG_Processing/scripts';
...
% Trigger channel indices in the EEG data 运动任务用 38、39通道
trigChans = [38 39];
...
for i = 1:numel(SUB)
    ...
    baseName = sprintf('%s_task-cate_eeg', sid);
