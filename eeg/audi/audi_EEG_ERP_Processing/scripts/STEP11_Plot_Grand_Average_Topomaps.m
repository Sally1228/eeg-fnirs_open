...
fprintf('[%s] STEP11 Plot grand average topomaps\n', datestr(now, 'yyyy-mm-dd HH:MM:SS'));


%*************************************************************************************************************************************

%Set mean amplitude time window in milliseconds (e.g., 300 to 600 ms)
timewindow = [200 500];
...
ERP = pop_loaderp('filename', 'GA_audi_erp_ar_diff_waves.erp', 'filepath', ga_output_dir);  
...
save2pdf(fullfile(ga_output_dir, 'GA_audi_Topomaps.pdf'));
close all
